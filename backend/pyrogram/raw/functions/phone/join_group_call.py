...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["call", "params", "muted"]

    ID = 0x5f9c8e62
    QUALNAME = "functions.phone.JoinGroupCall"

    def __init__(self, *, call: "raw.base.InputGroupCall", params: "raw.base.DataJSON",
    ...
    def read(data: BytesIO, *args: Any) -> "JoinGroupCall":
        ...
        return JoinGroupCall(call=call, params=params, muted=muted)
