...
class DocumentAttributeAudio(TLObject):  # type: ignore
    ...
    def __init__(self, *, duration: int, voice: Union[None, bool] = None, title: Union[None, str] = None,
                 performer: Union[None, str] = None, waveform: Union[None, bytes] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "DocumentAttributeAudio":
        ...
        return DocumentAttributeAudio(duration=duration, voice=voice, title=title, performer=performer,
                                      waveform=waveform)
