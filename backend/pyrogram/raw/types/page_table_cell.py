...
class PageTableCell(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["header", "align_center", "align_right", "valign_middle", "valign_bottom", "text",
                            "colspan", "rowspan"]

    ID = 0x34566b6a
    QUALNAME = "types.PageTableCell"

    def __init__(self, *, header: Union[None, bool] = None, align_center: Union[None, bool] = None,
                 align_right: Union[None, bool] = None, valign_middle: Union[None, bool] = None,
                 valign_bottom: Union[None, bool] = None, text: "raw.base.RichText" = None,
                 colspan: Union[None, int] = None, rowspan: Union[None, int] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "PageTableCell":
        ...
        return PageTableCell(header=header, align_center=align_center, align_right=align_right,
                             valign_middle=valign_middle, valign_bottom=valign_bottom, text=text, colspan=colspan,
                             rowspan=rowspan)
