...
class UpdateReadChannelInbox(TLObject):  # type: ignore
    ...
    def __init__(self, *, channel_id: int, max_id: int, still_unread_count: int, pts: int,
    ...
    def read(data: BytesIO, *args: Any) -> "UpdateReadChannelInbox":
        ...
        return UpdateReadChannelInbox(channel_id=channel_id, max_id=max_id, still_unread_count=still_unread_count,
                                      pts=pts, folder_id=folder_id)
