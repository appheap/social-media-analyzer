...
class ChannelParticipantBanned(TLObject):  # type: ignore
    ...
    def __init__(self, *, user_id: int, kicked_by: int, date: int, banned_rights: "raw.base.ChatBannedRights",
                 left: Union[None, bool] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "ChannelParticipantBanned":
        ...
        return ChannelParticipantBanned(user_id=user_id, kicked_by=kicked_by, date=date, banned_rights=banned_rights,
                                        left=left)
