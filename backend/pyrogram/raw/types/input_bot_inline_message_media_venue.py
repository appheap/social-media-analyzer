...
class InputBotInlineMessageMediaVenue(TLObject):  # type: ignore
    ...
    def read(data: BytesIO, *args: Any) -> "InputBotInlineMessageMediaVenue":
        ...
        return InputBotInlineMessageMediaVenue(geo_point=geo_point, title=title, address=address, provider=provider,
                                               venue_id=venue_id, venue_type=venue_type, reply_markup=reply_markup)
