...
class SecureRequiredType(TLObject):  # type: ignore
    ...
    def __init__(self, *, type: "raw.base.SecureValueType", native_names: Union[None, bool] = None,
                 selfie_required: Union[None, bool] = None, translation_required: Union[None, bool] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "SecureRequiredType":
        ...
        return SecureRequiredType(type=type, native_names=native_names, selfie_required=selfie_required,
