...
class DraftMessage(TLObject):  # type: ignore
    ...
    def __init__(self, *, message: str, date: int, no_webpage: Union[None, bool] = None,
    ...
    def read(data: BytesIO, *args: Any) -> "DraftMessage":
        ...
        return DraftMessage(message=message, date=date, no_webpage=no_webpage, reply_to_msg_id=reply_to_msg_id,
                            entities=entities)
