...
class GroupCall(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["call", "participants", "participants_next_offset", "users"]

    ID = 0x66ab0bfc
    QUALNAME = "types.phone.GroupCall"

    def __init__(self, *, call: "raw.base.GroupCall", participants: List["raw.base.GroupCallParticipant"],
                 participants_next_offset: str, users: List["raw.base.User"]) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "GroupCall":
        ...
        return GroupCall(call=call, participants=participants, participants_next_offset=participants_next_offset,
                         users=users)
