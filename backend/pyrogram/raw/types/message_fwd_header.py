...
class MessageFwdHeader(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["date", "from_id", "from_name", "channel_id", "channel_post", "post_author",
                            "saved_from_peer", "saved_from_msg_id", "psa_type"]

    ID = 0x353a686b
    QUALNAME = "types.MessageFwdHeader"

    def __init__(self, *, date: int, from_id: Union[None, int] = None, from_name: Union[None, str] = None,
                 channel_id: Union[None, int] = None, channel_post: Union[None, int] = None,
    ...
    def read(data: BytesIO, *args: Any) -> "MessageFwdHeader":
        ...
        from_id = Int.read(data) if flags & (1 << 0) else None
        from_name = String.read(data) if flags & (1 << 5) else None
        date = Int.read(data)

        channel_id = Int.read(data) if flags & (1 << 1) else None
        ...
        return MessageFwdHeader(date=date, from_id=from_id, from_name=from_name, channel_id=channel_id,
