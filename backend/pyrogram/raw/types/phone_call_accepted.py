...
class PhoneCallAccepted(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, access_hash: int, date: int, admin_id: int, participant_id: int, g_b: bytes,
    ...
    def read(data: BytesIO, *args: Any) -> "PhoneCallAccepted":
        ...
        return PhoneCallAccepted(id=id, access_hash=access_hash, date=date, admin_id=admin_id,
                                 participant_id=participant_id, g_b=g_b, protocol=protocol, video=video)
