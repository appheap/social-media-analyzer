...
class ChannelAdminLogEventActionChangeStickerSet(TLObject):  # type: ignore
    ...
    def __init__(self, *, prev_stickerset: "raw.base.InputStickerSet",
                 new_stickerset: "raw.base.InputStickerSet") -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "ChannelAdminLogEventActionChangeStickerSet":
        ...
        return ChannelAdminLogEventActionChangeStickerSet(prev_stickerset=prev_stickerset,
