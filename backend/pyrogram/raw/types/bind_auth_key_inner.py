...
class BindAuthKeyInner(TLObject):  # type: ignore
    ...
    def __init__(self, *, nonce: int, temp_auth_key_id: int, perm_auth_key_id: int, temp_session_id: int,
                 expires_at: int) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "BindAuthKeyInner":
        ...
        return BindAuthKeyInner(nonce=nonce, temp_auth_key_id=temp_auth_key_id, perm_auth_key_id=perm_auth_key_id,
                                temp_session_id=temp_session_id, expires_at=expires_at)
