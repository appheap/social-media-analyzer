...
class Message(TLObject):  # type: ignore
    ...
    __slots__: List[str] = ["id", "to_id", "date", "message", "out", "mentioned", "media_unread", "silent", "post",
                            "from_scheduled", "legacy", "edit_hide", "from_id", "fwd_from", "via_bot_id",
                            "reply_to_msg_id", "media", "reply_markup", "entities", "views", "edit_date", "post_author",
                            "grouped_id", "restriction_reason"]

    ID = 0x452c0e65
    QUALNAME = "types.Message"

    def __init__(self, *, id: int, to_id: "raw.base.Peer", date: int, message: str, out: Union[None, bool] = None,
                 ...
                 edit_hide: Union[None, bool] = None, from_id: Union[None, int] = None,
                 fwd_from: "raw.base.MessageFwdHeader" = None, via_bot_id: Union[None, int] = None,
                 reply_to_msg_id: Union[None, int] = None, media: "raw.base.MessageMedia" = None,
    ...
    def read(data: BytesIO, *args: Any) -> "Message":
        ...
        return Message(id=id, to_id=to_id, date=date, message=message, out=out, mentioned=mentioned,
                       media_unread=media_unread, silent=silent, post=post, from_scheduled=from_scheduled,
                       legacy=legacy, edit_hide=edit_hide, from_id=from_id, fwd_from=fwd_from, via_bot_id=via_bot_id,
                       reply_to_msg_id=reply_to_msg_id, media=media, reply_markup=reply_markup, entities=entities,
                       views=views, edit_date=edit_date, post_author=post_author, grouped_id=grouped_id,
