...
class DcOption(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: int, ip_address: str, port: int, ipv6: Union[None, bool] = None,
                 media_only: Union[None, bool] = None, tcpo_only: Union[None, bool] = None,
                 cdn: Union[None, bool] = None, static: Union[None, bool] = None,
                 secret: Union[None, bytes] = None) -> None:
        self.id = id  # int
    ...
    def read(data: BytesIO, *args: Any) -> "DcOption":
        ...
        return DcOption(id=id, ip_address=ip_address, port=port, ipv6=ipv6, media_only=media_only, tcpo_only=tcpo_only,
                        cdn=cdn, static=static, secret=secret)
