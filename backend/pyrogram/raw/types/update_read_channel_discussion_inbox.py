...
class UpdateReadChannelDiscussionInbox(TLObject):  # type: ignore
    ...
    def __init__(self, *, channel_id: int, top_msg_id: int, read_max_id: int, broadcast_id: Union[None, int] = None,
                 broadcast_post: Union[None, int] = None) -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "UpdateReadChannelDiscussionInbox":
        ...
        return UpdateReadChannelDiscussionInbox(channel_id=channel_id, top_msg_id=top_msg_id, read_max_id=read_max_id,
                                                broadcast_id=broadcast_id, broadcast_post=broadcast_post)
