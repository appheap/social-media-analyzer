...
class Difference(TLObject):  # type: ignore
    ...
    def __init__(self, *, new_messages: List["raw.base.Message"],
                 ...
                 chats: List["raw.base.Chat"], users: List["raw.base.User"], state: "raw.base.updates.State") -> None:
    ...
    def read(data: BytesIO, *args: Any) -> "Difference":
        ...
        return Difference(new_messages=new_messages, new_encrypted_messages=new_encrypted_messages,
                          other_updates=other_updates, chats=chats, users=users, state=state)
