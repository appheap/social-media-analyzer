...
class ChannelDifferenceTooLong(TLObject):  # type: ignore
    ...
    def __init__(self, *, dialog: "raw.base.Dialog", messages: List["raw.base.Message"], chats: List["raw.base.Chat"],
                 users: List["raw.base.User"], final: Union[None, bool] = None,
    ...
    def read(data: BytesIO, *args: Any) -> "ChannelDifferenceTooLong":
        ...
        return ChannelDifferenceTooLong(dialog=dialog, messages=messages, chats=chats, users=users, final=final,
                                        timeout=timeout)
