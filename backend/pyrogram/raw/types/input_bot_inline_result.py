...
class InputBotInlineResult(TLObject):  # type: ignore
    ...
    def __init__(self, *, id: str, type: str, send_message: "raw.base.InputBotInlineMessage",
                 title: Union[None, str] = None, description: Union[None, str] = None, url: Union[None, str] = None,
                 thumb: "raw.base.InputWebDocument" = None, content: "raw.base.InputWebDocument" = None) -> None:
        self.id = id  # string
    ...
    def read(data: BytesIO, *args: Any) -> "InputBotInlineResult":
        ...
        return InputBotInlineResult(id=id, type=type, send_message=send_message, title=title, description=description,
