...
InputStickerSet = Union[
    raw.types.InputStickerSetAnimatedEmoji, raw.types.InputStickerSetDice, raw.types.InputStickerSetEmpty, raw.types.InputStickerSetID, raw.types.InputStickerSetShortName]
