...
class User(Object, Update):
    ...
    def __init__(
            ...
            *,
            ...
            bot_can_be_added_to_group: bool = None,
            bot_can_see_history: bool = None,
            bot_can_request_geo: bool = None,
    ):
        ...
        self.bot_can_be_added_to_group = bot_can_be_added_to_group
        self.bot_can_see_history = bot_can_see_history
        self.bot_can_request_geo = bot_can_request_geo
    ...
    def _parse(client, user: "raw.types.User") -> "User" or None:
        ...
        return User(
            ...
            **User._parse_status(user.status, user.bot),
            ...
            bot_can_be_added_to_group=getattr(user, 'bot_nochats', None),
            bot_can_see_history=getattr(user, 'bot_chat_history', None),
            bot_can_request_geo=getattr(user, 'bot_inline_geo', None),
